...
ball_radius = 20
ball_color = RED
ball_position = Vector2(WIDTH // 2, HEIGHT // 2)  # Start at the center of the screen
ball_velocity = Vector2(0, -50)  # Initial velocity
GRAVITY = 9.8  # Horizontal acceleration
...
while True:
    ...
    # Update verical velocity and position
